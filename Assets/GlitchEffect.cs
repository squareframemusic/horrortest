...
public class GlitchEffect : ImageEffectBase {
    ...
    //create one instance of FMOD event here.
    FMOD.Studio.EventInstance WhiteNoise;
    FMOD.Studio.EventInstance WhiteNoise02;
    FMOD.Studio.EventInstance WhiteNoise03;

	private void Awake()
	{
        WhiteNoise = FMODUnity.RuntimeManager.CreateInstance("event:/SFX/Glitch01");
        WhiteNoise = FMODUnity.RuntimeManager.CreateInstance("event:/SFX/Glitch02");
        WhiteNoise = FMODUnity.RuntimeManager.CreateInstance("event:/SFX/Glitch03");
	}
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination) {
        ...
        if (flicker > flickerTime){
            ...
            WhiteNoise03.stop(FMOD.Studio.STOP_MODE.IMMEDIATE);
        }
...
//                WhiteNoise.setPitch(-19);
            ...
            else
            {
                ...
                WhiteNoise02.stop(FMOD.Studio.STOP_MODE.IMMEDIATE);
            }
		}
